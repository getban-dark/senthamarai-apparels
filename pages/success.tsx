...
import { fetchLineItems } from "../util/fetchLineItems";
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <div className="relative flex h-16 w-16 items-center justify-center rounded-md border border-gray-300 bg-[#F1F1F1] text-xs text-white">
                        <div className="relative flex animate-bounce items-center rounded-md">
                          <AiFillCheckCircle className="h-9 w-9 text-green-600" />
                        </div>
